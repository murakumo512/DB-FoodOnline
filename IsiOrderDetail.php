...
while($a=mysqli_fetch_array($ambildatadet))
{
     ...
     echo "<td align='right'>";
	 ?>
	 <a href='del_order_det.php?id=<?php echo $Ord_id ?>&Ship_nota=<?php echo $Ship_nota?>
	 &resid=<?php echo  $resid ?>&qty= <?php echo $qty ?>&FodDr_Id=<?php echo $FodDr_Id ?>' title='Delete Order Detail'>Delete</a></td>
     <?php
	 echo "</td>";	 
	 echo "</tr>";
 ...
 ?>
	 ...
	 <td ><a href="save_oder_detail.php?id=<?php echo $Ship_nota;?>
	 &resid=<?php echo  $resid ?>&edit=ok&tot=<?php echo $tot?>
	 &Balanced=<?php echo $xBalanced ?>&Driver_id=<?php echo $Driver_Id ?>" title="fix">Fix Pesann</a></td>
