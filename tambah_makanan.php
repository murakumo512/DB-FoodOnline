...
tr:nth-child(even) {
 ...
 <title>Tambah Data Food</title>
</head>
<body>
 <h1>Tambah Data Food</h1>
 <br>
 <?php 
...
<th> <?php echo $rest; ?></th>
  ...
  <tr> 
	<th>FoDr_Name: <input type="text" name="FoDr_Name" value="" ></th>
	<th>FoDr_Price: <input type="text" name="FoDr_Price" value=""></th>
	<th>FoDr_Stock: <input type="text" name="FoDr_Stock" value=""></th>
  </tr> 
  <tr> 
