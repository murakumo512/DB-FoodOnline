...
<h1 align="center"> Data Restoran</h1>
    <table border="1" width="900" align="center">
       ...
       <tr>
	   <!--
           <td colspan="9"><a href="tambah_makanan.php" title="input data">Tambah</a></td>
...
where food_and_drink.Restaurant_Id=$idres order by restaurant_name";
...
<h1 align="center"> 
  <p><a href="utama.php">ke Menu Utama</a></p>
    <p><a href="r.php">ke Menu Restaurant</a></p>
</h1>
</body>
</html>
